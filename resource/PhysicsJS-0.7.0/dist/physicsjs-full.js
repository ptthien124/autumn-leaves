...
(function (root, factory) {
  ...
  (function () {
    ...
    var getClosestPoints = function getClosestPoints(simplex) {
      ...
      return scratch.done({
        ...
        a: A.clone(last.a)
          .mult(lambdaA)
          .vadd(L.clone(prev.a).mult(lambdaB))
          .values(),
        // b closest = lambdaA * Ab + lambdaB * Bb
        b: A.clone(last.b)
          .mult(lambdaA)
          .vadd(L.clone(prev.b).mult(lambdaB))
          .values(),
      });
    };
    ...
    var gjk = function gjk(support, seed, checkOverlapOnly, debugFn) {
      ...
      while (++iterations) {
        ...
        if (simplexLen === 2) {
          ...
          dir = getNextSearchDir(
            v1.clone(simplex[1].pt),
            v2.clone(simplex[0].pt),
            dir
          );
          // continue...
  ...
  (function (window) {
    ...
    Vector.prototype.angle = function (v) {
      ...
      if (this.equals(Vector.zero)) {
        ...
        if (v && !v.equals(Vector.zero)) {
          ang = atan2(
            this._[1] * v._[0] - this._[0] * v._[1],
            this._[0] * v._[0] + this._[1] * v._[1]
          );
        } else {
    ...
    Vector.prototype.rotateInv = function (t) {
      return this.set(
        (this._[0] - t.o._[0]) * t.cosA +
          (this._[1] - t.o._[1]) * t.sinA +
          t.o._[0],
        -(this._[0] - t.o._[0]) * t.sinA +
          (this._[1] - t.o._[1]) * t.cosA +
          t.o._[1]
      );
    };
    ...
    Vector.prototype.equals = function (v) {
      return (
        this._[0] === v._[0] && this._[1] === v._[1] && this._[2] === v._[2]
      );
    };
     ...
     * ```
     **/
    Vector.axis = [new Vector(1.0, 0.0), new Vector(0.0, 1.0)];
   ...
   * ```
   **/
  var Decorator = (Physics.util.decorator = function Decorator(
    type,
    baseProto
  ) {
    var registry = {},
      ...
      if (typeof decorator === "function") {
        ...
        if (result) {
          result.prototype = extend(
            result.prototype,
            decorator(getProto(result.prototype))
          );
        } else {
          // newly defined
          // store the new class
          ...
          result.prototype = extend(
            result.prototype,
            decorator(parent, result.prototype)
          );
        }
  ...
  (function () {
    ...
    function cacheIndexOf(cache, value) {
      ...
      return type === "object"
        ? cache && Physics.util.indexOf(cache, value) > -1
          ? 0
          : -1
        : cache
        ? 0
     ...
     **/
    Physics.util.isPlainObject = !Object.getPrototypeOf
      ? shimIsPlainObject
      : function (value) {
          ...
          var valueOf = value.valueOf,
            objProto =
              isNative(valueOf) &&
              (objProto = Object.getPrototypeOf(valueOf)) &&
  ...
  Physics.scratchpad = (function () {
    // Errors
    var SCRATCH_USAGE_ERROR =
      "Error: Scratchpad used after .done() called. (Could it be unintentionally scoped?)";
    var SCRATCH_INDEX_OUT_OF_BOUNDS =
      "Error: Scratchpad usage space out of bounds. (Did you forget to call .done()?)";
    ...
    Scratchpad.fn = function (fn) {
      ...
      var handle = new Function(
        ...
        "return function(" +
          ...
          "scratch._active = true;" +
          "return scratch.done( fn(scratch, " +
          args +
          ") );" +
          "};"
      );
  ...
  (function () {
    ...
    Physics.body = Decorator("body", {
      ...
      sleepCheck: function (dt) {
        ...
        stats = Physics.statistics.pushRunningAvg(
          Math.sin(this.state.angular.pos),
          this._sleepMeanK,
          this._sleepAngPosMean,
          this._sleepAngPosVariance
        );
        ...
        v *= kfac;
        limit =
          this.sleepVarianceLimit || (opts && opts.sleepVarianceLimit) || 0;
   ...
   **/
  Physics.geometry.nearestPointOnLine = function nearestPointOnLine(
    pt,
    linePt1,
    linePt2
  ) {
    ...
    // guess we'd better do the math now...
    p = new Physics.vector(linePt2)
      .mult(lambdaB)
      .vadd(A.clone(linePt1).mult(lambdaA));
    scratch.done();
    return p;
  };
  ...
  (function () {
    ...
    Physics.renderer = Decorator("renderer", {
      ...
      init: function (options) {
        ...
        this.drawMeta = Physics.util.throttle(
          Physics.util.bind(this.drawMeta, this),
          this.options.metaRefresh
        );

        window.addEventListener(
          "resize",
          Physics.util.throttle(function () {
      ...
      render: function (bodies, meta) {
        ...
        for (var i = 0, l = bodies.length; i < l; ++i) {
          ...
          view =
            body.view ||
            (body.view = this.createView(body.geometry, body.styles));
      ...
      add: function (arg) {
        ...
        do {
          switch (thing.type) {
            ...
            default:
              throw (
                'Error: failed to add item of unknown type "' +
                thing.type +
                '" to world'
              );
            // end default
      ...
      remove: function (arg) {
        ...
        do {
          switch (thing.type) {
            ...
            default:
              throw (
                'Error: failed to remove item of unknown type "' +
                thing.type +
                '" from world'
              );
            // end default
  ...
  Physics.geometry("convex-polygon", function (parent) {
    var ERROR_NOT_CONVEX =
      "Error: The vertices specified do not match that of a _convex_ polygon.";
    ...
    return {
      ...
      setVertices: function (hull) {
        ...
        transl.setTranslation(
          Physics.geometry.getPolygonCentroid(hull).negate()
        );
      ...
      getFarthestCorePoint: function (dir, result, margin) {
        ...
        next
          .clone(verts[(data.idx + 1) % l])
          .vsub(result)
          .normalize()
          .perp(sign);
        prev
          .clone(verts[(data.idx - 1 + l) % l])
          .vsub(result)
          .normalize()
          .perp(!sign);
  ...
  Physics.body("circle", function (parent) {
    ...
    return {
      ...
      recalc: function () {
        ...
        // moment of inertia
        this.moi =
          (this.mass * this.geometry.radius * this.geometry.radius) / 2;
      },
    };
  });
  ...
  Physics.behavior("body-collision-detection", function (parent) {
    ...
    var getSupportFn = function getSupportFn(bodyA, bodyB) {
      ...
      if (!fn) {
        fn = supportFnStack[hash] = function pairSupportFunction(searchDir) {
          var tA = fn.tA,
            ...
            vB = fn.tmpv2;
          if (fn.useCore) {
            vA = bodyA.geometry.getFarthestCorePoint(
              searchDir.rotateInv(tA),
              vA,
              fn.marginA
            );
            vB = bodyB.geometry.getFarthestCorePoint(
              searchDir.rotate(tA).rotateInv(tB).negate(),
              vB,
              fn.marginB
            );
          } else {
            vA = bodyA.geometry.getFarthestHullPoint(
              searchDir.rotateInv(tA),
              vA
            );
            vB = bodyB.geometry.getFarthestHullPoint(
              searchDir.rotate(tA).rotateInv(tB).negate(),
              vB
            );
          }
      ...
      fn.margin = 0;
      fn.tA
        .setRotation(bodyA.state.angular.pos)
        .setTranslation(bodyA.state.pos);
      fn.tB
        .setRotation(bodyB.state.angular.pos)
        .setTranslation(bodyB.state.pos);
      fn.bodyA = bodyA;
      fn.bodyB = bodyB;
    ...
    var checkGJK = function checkGJK(bodyA, bodyB) {
      ...
      if (result.overlap) {
        ...
        while (
          (result.overlap || result.distance === 0) &&
          (support.marginA < dimA || support.marginB < dimB)
        ) {
    ...
    var checkCircles = function checkCircles(bodyA, bodyB) {
      ...
      if (overlap <= 0) {
        collision = {
          ...
          pos: d
            .mult(-bodyA.geometry.radius / overlap)
            .vadd(tmp)
            .values(),
          overlap: -overlap,
        };
    ...
    var checkPair = function checkPair(bodyA, bodyB) {
      ...
      if (
        bodyA.geometry.name === "circle" &&
        bodyB.geometry.name === "circle"
      ) {
        return checkCircles(bodyA, bodyB);
      } else if (
        bodyA.geometry.name === "compound" ||
        bodyB.geometry.name === "compound"
      ) {
        ...
        for (i = 0, l = compound.children.length; i < l; i++) {
          ...
          ch.offset.vadd(
            oldPos.vadd(compound.offset).rotate(-ch.state.angular.pos)
          );
          ...
          ch.state.pos.clone(
            oldPos.rotate(ch.state.angular.pos).vsub(compound.offset)
          );
        }
    ...
    return {
      ...
      respond: function (data) {
        ...
        for (i = 0, l = collisions.length; i < l; ++i) {
          ...
          col.bodyA._oldmtvTotal =
            col.bodyA._oldmtvTotal || new Physics.vector();
          col.bodyB._oldmtvTotal =
            col.bodyB._oldmtvTotal || new Physics.vector();
    ...
    var checkGeneral = function checkGeneral(body, bounds, dummy) {
      ...
      if (overlap >= 0) {
        ...
        collision = {
          ...
          pos: body.geometry
            .getFarthestHullPoint(dir, result)
            .rotate(trans)
            .vadd(offset)
            .values(),
        };
      ...
      init: function (options) {
        ...
        self.grab = function grab(e) {
          ...
          if (self._world) {
            ...
            for (
              touchIndex = 0, l = e.changedTouches.length;
              touchIndex < l;
              touchIndex++
            ) {
              ...
              body = self._world.findOne({
                $at: new Physics.vector(pos),
                $in: self.getTargets(),
              });
              ...
              if (body) {
                ...
                data.treatment = self.bodyDataByUID[body.uid]
                  ? self.bodyDataByUID[body.uid].treatment
                  : body.treatment;
          ...
          if (self._world) {
            ...
            for (
              ...
              if (data) {
                ...
                dt = Math.max(
                  Physics.util.ticker.now() - data.time,
                  self.options.moveThrottle
                );
            ...
            if (comp) {
              if (other.name === "compound") {
                ...
                for (k = 0, ll = comp.children.length; k < ll; k++) {
                  ...
                  other.accelerate(
                    potential.mult(bodyA.mass / other.mass).negate()
                  );
                }
              }
            } else {
          ...
          if (tracker.body === body) {
            ...
            for (var xyz = 0; xyz < maxDof; ++xyz) {
              ...
              for (var j = 0, m = list.length; j < m; ++j) {
                ...
                if (
                  minmax === tracker.interval.min ||
                  minmax === tracker.interval.max
                ) {
    ...
    return {
      ...
      angleConstraint: function (bodyA, bodyB, bodyC, stiffness, targetAngle) {
        ...
        cst = {
          ...
          targetAngle:
            targetAngle ||
            bodyB.state.pos.angle2(bodyA.state.pos, bodyC.state.pos),
        };
      ...
      remove: function (cstrOrId) {
        ...
        constraints =
          type === "ang" ? this._angleConstraints : this._distanceConstraints;
      ...
      resolveAngleConstraints: function (coef) {
        ...
        for (var i = 0, l = constraints.length; i < l; ++i) {
          ...
          ang = con.bodyB.state.pos.angle2(
            con.bodyA.state.pos,
            con.bodyC.state.pos
          );
          ...
          if (
            con.bodyA.treatment === "dynamic" &&
            con.bodyB.treatment === "dynamic" &&
            con.bodyC.treatment === "dynamic"
          ) {
          ...
          if (con.bodyC.treatment === "dynamic") {
            if (
              ...
              ang =
                (-corr * con.bodyA.mass) / (con.bodyC.mass + con.bodyA.mass);
            } else {
              ang =
                (-corr * con.bodyB.mass) / (con.bodyB.mass + con.bodyC.mass);
            }
      ...
      resolveDistanceConstraints: function (coef) {
        ...
        for (var i = 0, l = constraints.length; i < l; ++i) {
          ...
          proportion =
            ...
            con.bodyB.treatment !== "dynamic"
              ? 1
              : con.bodyB.mass / (con.bodyA.mass + con.bodyB.mass);
      ...
      shuffleConstraints: function () {
        this._distanceConstraints = Physics.util.shuffle(
          this._distanceConstraints
        );
      ...
      integratePositions: function (bodies, dt) {
        ...
        for (var i = 0, l = bodies.length; i < l; ++i) {
          ...
          if (body.treatment !== "static" && !body.sleep()) {
            ...
            state.old.angular.pos = state.angular.pos;
            state.angular.pos +=
              state.old.angular.vel * dt + state.old.angular.acc * halfdtdt;
          ...
          if (body.treatment !== "static") {
            ...
            if (!body.started()) {
              ...
              state.old.angular.vel =
                state.angular.vel - state.old.angular.acc * dt;
            }

            state.angular.vel +=
              0.5 * (state.angular.acc + state.old.angular.acc) * dt;
            state.angular.acc = 0;
      ...
      integratePositions: function (bodies, dt) {
        ...
        for (var i = 0, l = bodies.length; i < l; ++i) {
          ...
          if (body.treatment !== "static") {
            ...
            state.angular.pos +=
              state.angular.vel * dt + 0.5 * state.old.angular.acc * dtdt;
            state.old.angular.vel = state.angular.vel;
            state.old.angular.acc = state.angular.acc;
            state.angular.acc = 0;
          }
    ...
    return {
        ...
        layer.render = function (clear) {
          ...
          if (layer.options.offset) {
            if (layer.options.offset === "center") {
              offset
                .add(layer.el.width * 0.5, layer.el.height * 0.5)
                .mult(1 / scale);
            } else {
          ...
          if (layer.options.follow) {
            ...
            offset.sub(
              layer.options.follow.state.vel.get(0) * t,
              layer.options.follow.state.vel.get(1) * t
            );
          }
      ...
      setStyle: function (styles, ctx) {
        ...
        if (Physics.util.isObject(styles)) {
          styles.strokeStyle = styles.lineWidth
            ? styles.strokeStyle
            : "rgba(0,0,0,0)";
      ...
      createView: function (geometry) {
        ...
        if (geometry.name === "compound") {
          for (var i = 0, l = geometry.children.length, ch; i < l; i++) {
            ...
            chel = newEl();
            chel.className =
              classpfx + geometry.name + " " + classpfx + "child";
  ...
  Physics.renderer("pixi", function (parent) {
    ...
    return {
      ...
      detach: function (data) {
        // interpred data as either dom node or event data
        var el =
          (data instanceof PIXI.Graphics && data) ||
          (data.body && data.body.view);
      ...
      setStyles: function (graphics, styles) {
        if (Physics.util.isObject(styles)) {
          if (styles.fillStyle && styles.fillStyle !== "transparent") {
            ...
            graphics.fillAlpha =
              styles.fillAlpha !== undefined ? styles.fillAlpha : 1;
          } else {
            graphics.beginFill();
          ...
          graphics.lineStyle(
            styles.lineWidth || 0,
            styles.strokeStyle,
            styles.strokeAlpha !== undefined ? styles.strokeAlpha : 1
          );
      ...
      createView: function (geometry, styles, parent) {
        ...
        if (name === "circle") {
          ...
          for (
            var i = 0, l = geometry.children.length, ch, chview;
            i < l;
            i++
          ) {
            ch = geometry.children[i];
        ...
        if (
          ...
          styles.angleIndicator !== "transparent"
        ) {
